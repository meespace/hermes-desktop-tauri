...
> - This Tauri build does not use the official Hermes Desktop updater, so official Electron artifacts cannot replace this UI
...
- Desktop updates are checked against this Tauri repository and stay manual; the official Hermes Desktop updater is not used by this build
...
Issues, pull requests, side-by-side testing, and parity review are all welcome.
