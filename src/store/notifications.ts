...
const ERROR_SUMMARIES: { test: (msg: string) => boolean; summarize: (msg: string) => string }[] = [
  ...
  },
  {
    ...
    summarize: () =>
      'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Hermes Desktop Community.'
  },
  {
    test: msg => /microphone permission|microphone access denied/i.test(msg),
