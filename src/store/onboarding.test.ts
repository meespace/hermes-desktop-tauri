...
describe('requestDesktopOnboarding', () => {
  ...
  it('ignores missing API key warnings for local providers', () => {
    requestDesktopOnboarding("No API key configured for provider 'ollama-local'. First message will fail.")
  ...
  it('keeps missing API key warnings for remote providers', () => {
...
describe('saveOnboardingLocalEndpoint', () => {
  ...
  it('errors when the endpoint advertises no models', async () => {
    const calls: string[] = []
