...
function RootErrorFallback({ error, reset }: ErrorBoundaryFallbackProps) {
  return (
    <div className="fixed inset-0 z-[1500] flex items-center justify-center bg-backdrop p-6 backdrop-blur-md">
      <div className="w-full max-w-[40rem] overflow-hidden rounded-[min(30px,var(--radius-3xl))] border border-[var(--border)] bg-[var(--overlay)] shadow-[var(--overlay-shadow)]">
