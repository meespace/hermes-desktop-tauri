...
export const DIRECTIVE_CHIP_CLASS =
  'mx-0.5 inline-flex max-w-56 items-center gap-1 rounded px-1.5 py-0.5 align-[0.02em] text-[0.86em] font-normal leading-none bg-[color-mix(in_srgb,currentColor_8%,transparent)] text-[var(--muted)]'
...
const DirectiveImage: FC<{ id: string; label: string }> = ({ id, label }) => {
  ...
  return (
    <ZoomableImage
      alt={label}
      className="max-h-32 max-w-48 rounded-md border border-[var(--border)] object-contain"
      draggable={false}
