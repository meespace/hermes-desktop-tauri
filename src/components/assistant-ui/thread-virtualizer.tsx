  ...
  return (
    ...
    >
      ...
      >
        {renderEmpty ? (
          <div
            className="mx-auto grid h-full w-full max-w-[min(100%,56rem)] grid-rows-[minmax(0,1fr)_auto] min-w-0 gap-(--conversation-turn-gap) px-5 py-6 sm:px-7"
          ...
          <div
            className={cn(
              'mx-auto flex w-full max-w-[min(100%,56rem)] min-w-0 flex-col px-5 pt-5 sm:px-7'
            )}
            data-slot="aui_thread-content"
          >
