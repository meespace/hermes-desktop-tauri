...
describe('onboarding Picker', () => {
  it('does not auto-open when the app is merely running normally', () => {
    setProviders([provider('nous', 'Nous Portal')])
    render(<DesktopOnboardingOverlay onCompleted={() => undefined} requestGateway={ctx.requestGateway} />)

    expect(document.querySelector('[data-slot="desktop-onboarding-overlay-card"]')).toBeNull()
  })
