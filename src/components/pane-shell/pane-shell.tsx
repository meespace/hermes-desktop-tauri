    ...
    >
      {canResize && (
        <div
          ...
          tabIndex={0}
        >
          <span className="absolute inset-y-0 left-1/2 w-[var(--vscode-sash-hover-size,0.25rem)] -translate-x-1/2 bg-[color-mix(in_srgb,var(--accent)_32%,transparent)] opacity-0 transition-opacity duration-100 group-hover:opacity-100 group-focus-visible:opacity-100" />
        </div>
      )}
      {children}
    </div>
