...
export interface PaginatedSessions {
  ...
  total: number
  /** Count per profile returned by /api/profiles/sessions. */
  profile_totals?: Record<string, number>
  /** Per-profile read failures returned by /api/profiles/sessions. */
...
export interface SessionInfo {
  ...
  /** Owning profile name from the cross-profile aggregator. */
  profile?: string
