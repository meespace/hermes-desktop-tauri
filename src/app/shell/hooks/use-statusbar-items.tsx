...
export function useStatusbarItems({
  ...
  const versionItem = useMemo<StatusbarItem>(() => {
    ...
    const tooltip = [
      ...
      appVersion && `Hermes Desktop Community v${appVersion}`,
      sha && `commit ${sha}`,
  ...
  const coreLeftStatusbarItems = useMemo<readonly StatusbarItem[]>(
    () => [
      {
        className: `w-7 justify-center px-0${commandCenterOpen ? ' bg-[var(--surface-secondary)] text-foreground' : ''}`,
        icon: <Command className="size-3.5" />,
        id: 'command-center',
        onSelect: toggleCommandCenter,
        title: commandCenterOpen ? t.shell.closeCommandCenter : t.shell.openCommandCenter,
        variant: 'action'
      },
      {
        ...
        id: 'gateway-health',
        label: t.shell.gateway,
        menuClassName: 'w-72',
        menuContent: gatewayMenuContent,
        title: inferenceStatus?.reason || t.shell.gatewayStatus,
        variant: 'menu'
      },
      {
        className: cn(
          agentsOpen && 'bg-[var(--surface-secondary)] text-foreground',
        ...
        onSelect: openAgents,
        title: agentsOpen ? t.shell.closeAgents : t.shell.openAgents,
        variant: 'action'
      },
      {
    ...
    () => [
      {
        ...
        id: 'running-timer',
        label: t.shell.running,
        title: t.shell.currentTurnElapsed,
        variant: 'text'
      },
      {
      ...
      },
      {
        ...
        title: t.shell.runtimeSessionElapsed,
        variant: 'text'
      },
      {
        id: 'model-summary',
        ...
        ...(modelMenuContent
          ? {
              ...
              title: currentProvider
                ? `${t.settings.sections.model} · ${currentProvider}: ${currentModel || 'none'}`
                : t.shell.switchModel,
