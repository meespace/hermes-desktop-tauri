...
export function AboutSettings() {
  ...
  if (!supported) {
    ...
    statusLine = 'Use "Check now" whenever you want to look for updates.'
  }
  ...
  return (
    <SettingsContent>
      ...
      <div className="mx-auto mt-4 w-full max-w-2xl">
        ...
        <ListRow
          description="Hermes only checks for updates when you ask it to from this screen or the updates window."
